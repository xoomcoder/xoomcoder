...
Naturellement, pour pouvoir gérer des projets avec de tels volumes de code, il faut bien s'organiser.
Une entreprise attend donc des développeurs que leur code soit bien organisé. 

🔥 Divide and Conquer.

C'est un principe ancien et connu des humains depuis des milliers d'années.
🔥 Séparer et ensuite Rassembler.

Pour déplacer une montagne, on peut découper des blocs et ensuite déplacer les bocs pour les rassembler ailleurs.
C'est comme ça que les égyptiens ont réussi à construire des pyramides qui existent toujours.

Dans le monde informatique, on est heureusement dans du virtuel, ça pèse moins lourd ques de blocs de pierre.
...
Depuis les années 90, la programmation orienté objet est devenu la technique standard dans les entreprises.
...
La plupart des langages orienté-objet ont déjà prévu une boite dans laquelle on pourra ranger les classes.
Dans le monde Java, on va parler de "package", dans le monde PHP, on va parler de "namespace"...
Ce sont les années 2000 qui ont vu ce besoin arriver.

Depuis, la tendance est de simplifier les langages et d'apporter de meilleurs outils aux développeurs. 
Les projets avec des millions de lignes de code sont difficiles à gérer pour la plupart des équipes.
