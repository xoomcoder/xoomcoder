...
use Incutio\XMLRPC\DataType\Error;
 ...
 * @package IXR
 */
class ObjectWrapper extends Base
{
    private $objects;
    private $delimiter;
    protected $callbacks;
    ...
    function registerObject($object, $methods, $prefix=null)
    {
        ...
        foreach($methods as $method)
        {
            ...
            $this->callbacks[$prefix . $this->delimiter . $method]=array($prefix, $targetMethod);
        }
    }
